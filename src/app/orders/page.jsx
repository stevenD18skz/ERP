                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="grid flex-1 grid-cols-1 gap-2 sm:grid-cols-12">
                      ...
                      {/* Costo unitario: fijo desde el catálogo, no editable */}
                      <div className="sm:col-span-2">
                        ...
                        <div
                          ...
                          title="El costo unitario viene del catálogo de productos"
                        >
                          {line.id ? currency(line.unit_cost) : "—"}
                        </div>
                      </div>
                      ...
                      <div className="sm:col-span-4">
                        ...
                        <div className="mt-1 flex items-center gap-2">
                          <button
                            ...
                            className="shrink-0 rounded-md border px-2 py-1 text-slate-600"
                          >
                            −
                          </button>
                          <input
                            ...
                            type="number"
                            min="1"
                            className="no-spinner w-16 min-w-0 flex-1 rounded-md border px-2 py-1 text-right"
                            value={line.quantity}
                            onChange={(e) =>
                              updateLine(idx, {
